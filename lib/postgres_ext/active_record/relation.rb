...
gdep_5_0 = Gem::Dependency.new('activerecord', '~> 5.0')
...
if ar_5_0_version_cutoff
  ...
  require 'postgres_ext/active_record/5.0/query_methods/arel_extension_handler'

elsif ar_4_2_version_cutoff
  require 'postgres_ext/active_record/relation/predicate_builder/array_handler'
  require 'postgres_ext/active_record/relation/query_methods/arel_extension_handler'

else
  require 'postgres_ext/active_record/4.x/relation/predicate_builder'
  require 'postgres_streeext/active_record/relation/query_methods/arel_extension_handler'
end
